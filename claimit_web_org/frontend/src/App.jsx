...
import { AdminUsers, AdminAds, AdminShops, AdminReviews, AdminTickets, AdminPDFs, AdminSalesTeam, AdminBillReviews, AdminBonusSettings } from './pages/admin/AdminPages'
