...
class ShopService {
  ...
  static const Map<int, _CatMeta> _catMeta = {
    ...
    6:  _CatMeta(Color(0xFFF3E5F5), Icons.checkroom_rounded),
    7:  _CatMeta(Color(0xFFE1F5FE), Icons.directions_walk_rounded),
    8:  _CatMeta(Color(0xFFFFF3E0), Icons.cake_rounded),
    9:  _CatMeta(Color(0xFFEDE7F6), Icons.devices_rounded),
    10: _CatMeta(Color(0xFFE3F2FD), Icons.smartphone_rounded),
    11: _CatMeta(Color(0xFFEFEBE9), Icons.chair_rounded),
    12: _CatMeta(Color(0xFFFFF8E1), Icons.king_bed_rounded),
    13: _CatMeta(Color(0xFFE1F5FE), Icons.kitchen_rounded),
    14: _CatMeta(Color(0xFFFCE4EC), Icons.child_care_rounded),
    15: _CatMeta(Color(0xFFE8EAF6), Icons.menu_book_rounded),
    16: _CatMeta(Color(0xFFFFF8E1), Icons.content_cut_rounded),
    17: _CatMeta(Color(0xFFFCE4EC), Icons.spa_rounded),
    18: _CatMeta(Color(0xFFE0F2F1), Icons.visibility_rounded),
    19: _CatMeta(Color(0xFFE8EAF6), Icons.biotech_rounded),
    20: _CatMeta(Color(0xFFFFEBEE), Icons.local_hospital_rounded),
  };
