...
const _allCategories = [
  ...
  _Cat('Hospitals',             Icons.local_hospital_rounded,   Color(0xFFDC2626)),
  _Cat('Optical\nStores',       Icons.visibility_rounded,       Color(0xFF0D9488)),
  _Cat('Diagnostics',           Icons.biotech_rounded,          Color(0xFF6366F1)),
  ...
  _Cat('Salons',                Icons.content_cut_rounded,      Color(0xFFF59E0B)),
