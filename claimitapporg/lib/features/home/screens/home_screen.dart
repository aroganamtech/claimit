...
class _HomeScreenState extends State<HomeScreen> with RouteAware {
  ...
  int _selectedIndex(BuildContext context) {
    final loc = GoRouterState.of(context).matchedLocation;
    if (loc.startsWith('/home')) return 0;
    // Slot 1 is the Learn Claimit tab.
  ...
  /// Centre button — opens the full Featured Zones grid.
  ///
  /// This was briefly narrowed to a two-button Reward/Redeem sheet, then put
  /// back at the client's request. The Explore Claimit strip on the home page
  /// and this grid now both exist; they share the same zone list and routing
  /// via features/home/data/explore_zones.dart.
  void _showFeaturedZones(BuildContext context) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
