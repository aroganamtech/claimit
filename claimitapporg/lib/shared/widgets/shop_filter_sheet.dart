...
const filterCats = <FilterCat>[
  ...
  FilterCat(2,  'Grocery /\nProvision', Icons.shopping_basket_rounded,   Color(0xFF10B981)),
  FilterCat(3,  'Medical\nStores',    Icons.local_pharmacy_rounded,    Color(0xFF06B6D4)),
  FilterCat(4,  'Restaurants',        Icons.restaurant_rounded,        Color(0xFFEC4899)),
  FilterCat(5,  'Mobile\nStores',     Icons.smartphone_rounded,        Color(0xFF0284C7)),
  FilterCat(6,  'Electronics',        Icons.devices_rounded,           Color(0xFF7C3AED)),
  FilterCat(7,  'Departmental',       Icons.apartment_rounded,         Color(0xFF0EA5E9)),
  FilterCat(8,  'Garment/\nFashion',  Icons.checkroom_rounded,         Color(0xFFDB2777)),
  FilterCat(9,  'Jewellery',          Icons.diamond_rounded,           Color(0xFFB45309)),
  FilterCat(10, 'Footwears',          Icons.directions_run_rounded,    Color(0xFF0369A1)),
  FilterCat(11, 'Coffee\nShops',      Icons.local_cafe_rounded,        Color(0xFF92400E)),
  FilterCat(12, 'Hospitals',          Icons.local_hospital_rounded,    Color(0xFFDC2626)),
  FilterCat(13, 'Optical\nStores',    Icons.visibility_rounded,        Color(0xFF0D9488)),
  FilterCat(14, 'Diagnostics',        Icons.biotech_rounded,           Color(0xFF6366F1)),
  FilterCat(15, 'Furniture\nStores',  Icons.chair_rounded,             Color(0xFF78350F)),
  FilterCat(16, 'Home Decor',         Icons.weekend_rounded,           Color(0xFFF59E0B)),
  FilterCat(17, 'Beauty\nParlours',   Icons.face_retouching_natural_rounded, Color(0xFFEC4899)),
  FilterCat(18, 'Salons',             Icons.content_cut_rounded,       Color(0xFFF59E0B)),
  FilterCat(19, 'Baby\nStores',       Icons.child_care_rounded,        Color(0xFFEC4899)),
  FilterCat(20, 'Online\nStores',     Icons.shopping_cart_rounded,     Color(0xFF4F46E5)),
];
