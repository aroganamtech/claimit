...
const filterCats = <FilterCat>[
  FilterCat(1,  'New deals',          Icons.local_offer_rounded,      Color(0xFFEF4444), isNew: true),
  FilterCat(2,  'Groceries',          Icons.shopping_basket_rounded,  Color(0xFF10B981)),
  FilterCat(3,  'Supermarket',        Icons.store_rounded,            Color(0xFF3B82F6)),
  FilterCat(4,  'Pharmacy',           Icons.local_pharmacy_rounded,   Color(0xFF06B6D4)),
  FilterCat(5,  'Salon',              Icons.content_cut_rounded,      Color(0xFFF59E0B)),
  FilterCat(6,  'Gym',                Icons.fitness_center_rounded,   Color(0xFF8B5CF6)),
  FilterCat(7,  'Restaurant',         Icons.restaurant_rounded,       Color(0xFFEC4899)),
  FilterCat(8,  'Cafes',              Icons.local_cafe_rounded,       Color(0xFF92400E)),
  FilterCat(9,  'Clothing',           Icons.checkroom_rounded,        Color(0xFFDB2777)),
  FilterCat(10, 'Department',         Icons.apartment_rounded,        Color(0xFF0284C7)),
  FilterCat(11, 'Electronics',        Icons.devices_rounded,          Color(0xFF7C3AED)),
  FilterCat(12, 'Books',              Icons.menu_book_rounded,        Color(0xFF0D9488)),
  FilterCat(13, 'Toys',               Icons.toys_rounded,             Color(0xFFF97316)),
  FilterCat(14, 'Baby',               Icons.child_care_rounded,       Color(0xFFEC4899)),
  FilterCat(15, 'Home Decor',         Icons.weekend_rounded,          Color(0xFFF59E0B)),
  FilterCat(16, 'Furniture',          Icons.chair_rounded,            Color(0xFF78350F)),
  FilterCat(17, 'Spa',                Icons.spa_rounded,              Color(0xFF059669)),
  FilterCat(18, 'Schools',            Icons.school_rounded,           Color(0xFF2563EB)),
  FilterCat(19, 'Colleges',           Icons.account_balance_rounded,  Color(0xFF1D4ED8)),
  FilterCat(20, 'Tutoring',           Icons.menu_book_outlined,       Color(0xFF9333EA)),
  FilterCat(21, 'Clinics',            Icons.local_hospital_rounded,   Color(0xFFEF4444)),
  FilterCat(22, 'Hospitals',          Icons.emergency_rounded,        Color(0xFFDC2626)),
  FilterCat(23, 'Pets',               Icons.pets_rounded,             Color(0xFF10B981)),
  FilterCat(24, 'Sports',             Icons.sports_soccer_rounded,    Color(0xFF16A34A)),
  FilterCat(25, 'Travel',             Icons.luggage_rounded,          Color(0xFFEF4444)),
  FilterCat(26, 'Mobile &\nAccess.',  Icons.smartphone_rounded,       Color(0xFF0284C7)),
  FilterCat(27, 'Computer &\nLaptop', Icons.laptop_rounded,           Color(0xFF6366F1)),
  FilterCat(28, 'Gifts',              Icons.card_giftcard_rounded,    Color(0xFFE11D48)),
  FilterCat(29, 'Jewellery',          Icons.diamond_rounded,          Color(0xFFB45309)),
  FilterCat(30, 'Shoes',              Icons.directions_run_rounded,   Color(0xFF0369A1)),
];
