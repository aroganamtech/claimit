...
const filterCats = <FilterCat>[
  ...
  FilterCat(8,  'Garments',            Icons.checkroom_rounded,           Color(0xFF7C3AED)),
  FilterCat(9,  'Fashion',             Icons.local_mall_rounded,          Color(0xFFDB2777)),
  FilterCat(10, 'Footwear',            Icons.directions_walk_rounded,     Color(0xFF0369A1)),
  FilterCat(11, 'Mobile',              Icons.smartphone_rounded,          Color(0xFF0284C7)),
  FilterCat(12, 'Electronics',         Icons.devices_rounded,             Color(0xFFF59E0B)),
  FilterCat(13, 'Salons',              Icons.content_cut_rounded,         Color(0xFF7C3AED)),
  FilterCat(14, 'Beauty\nParlours',    Icons.spa_rounded,                 Color(0xFFEC4899)),
  FilterCat(15, 'Dry Fruits\n& Nuts',  Icons.grain_rounded,               Color(0xFF16A34A)),
  FilterCat(16, 'Fashion\nAccessories', Icons.shopping_bag_rounded,       Color(0xFF2563EB)),
  FilterCat(17, 'Optical',             Icons.visibility_rounded,          Color(0xFF3B82F6)),
  FilterCat(18, 'Home\nAppliances',    Icons.kitchen_rounded,             Color(0xFF16A34A)),
  FilterCat(19, 'Furniture',           Icons.chair_rounded,               Color(0xFF06B6D4)),
  ...
  FilterCat(27, 'Hospitals',           Icons.local_hospital_rounded,      Color(0xFF06B6D4)),
  FilterCat(28, 'Photography\n& Studios', Icons.camera_alt_rounded,       Color(0xFFEC4899)),
  FilterCat(29, 'Pet Stores',          Icons.pets_rounded,                Color(0xFF92400E)),
  FilterCat(30, 'Training\nInstitutes', Icons.school_rounded,             Color(0xFFF59E0B)),
