...
const filterCats = <FilterCat>[
  ...
  FilterCat(8,  'Garments &\nFashion', Icons.checkroom_rounded,           Color(0xFFDB2777)),
  FilterCat(9,  'Footwear',            Icons.directions_walk_rounded,     Color(0xFF0369A1)),
  ...
  FilterCat(12, 'Salons',              Icons.content_cut_rounded,         Color(0xFFF59E0B)),
  FilterCat(13, 'Beauty\nParlours',    Icons.spa_rounded,                 Color(0xFFEC4899)),
  FilterCat(14, 'Dry Fruits\n& Nuts',  Icons.grain_rounded,               Color(0xFF92400E)),
  FilterCat(15, 'Fashion\nAccessories', Icons.watch_rounded,              Color(0xFFA21CAF)),
  FilterCat(16, 'Optical',             Icons.visibility_rounded,          Color(0xFF0D9488)),
  FilterCat(17, 'Home\nAppliances',    Icons.kitchen_rounded,             Color(0xFF0EA5E9)),
  FilterCat(18, 'Furniture',           Icons.chair_rounded,               Color(0xFF78350F)),
  ...
  FilterCat(22, 'Gifts &\nFancy',      Icons.card_giftcard_rounded,       Color(0xFFEF4444)),
  FilterCat(23, 'Toys &\nGames',       Icons.toys_rounded,                Color(0xFF8B5CF6)),
  FilterCat(24, 'Sports &\nFitness',   Icons.fitness_center_rounded,      Color(0xFF16A34A)),
  FilterCat(25, 'Photography\n& Studios', Icons.camera_alt_rounded,       Color(0xFF334155)),
  FilterCat(26, 'Diagnostic\nCentres', Icons.biotech_rounded,             Color(0xFF6366F1)),
  FilterCat(27, 'Hospitals',           Icons.local_hospital_rounded,      Color(0xFFDC2626)),
  FilterCat(28, 'Pet Stores',          Icons.pets_rounded,                Color(0xFF0D9488)),
];
