...
#         print(f"[S3-DEBUG] key={s3_key} url={presigned[:120] if presigned else 'NONE'}")
#         result["image_url"] = presigned or ""
...
#             if url:
#                 presigned_list.append(url)
#         if presigned_list:
#             result["image_urls"] = presigned_list
