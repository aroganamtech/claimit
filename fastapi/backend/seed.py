...
async def seed():
    ...
    for shop in SHOPS_SEED:
        ...
        print(f"   📷 Encoding image for '{shop['name']}' ({image_name}) …", end=" ")
        image_b64 = _image_to_base64(image_name)
